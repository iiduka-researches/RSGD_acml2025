...
from optimizers import RSGD, RAdam, RASA
    ...
    for init_batch, num_batch_up in init_batch_list:
        ...
        for lr_type in lr_type_list:
            for lr_max in lr_list:
                ...
                rsgd=RSGD(bs=bs, lr=lr) #########ここでrsgd読んでる。
                history = rsgd.solve(problem, point=initial, num_epochs=num_epochs, num_all_steps=num_all_steps)
